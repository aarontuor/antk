...
from antk.models import tensor_factor_model2
...
def return_parser():
    ...
    parser.add_argument("-uembed", metavar="UEMBED", type=int, default=50,
                        help="The size of the user embeddings.")
    parser.add_argument("-cembed", metavar="GEMBED", type=int, default=50,
                        help="The size of the context embeddings.")
    ...
    parser.add_argument("-context_key", metavar="CONTEXT_KEY", type=str, default='occ',
                        help="Context data key.")
    return parser
...
if __name__ == '__main__':
    ...
    x = tensor_factor_model2.tensorfactor(args.datadir,
    ...
    with open(args.logfile, 'a') as out:
        ...
        out.write("lamb=%f uembed=%d iembed=%d gembed=%d learnrate=%f mb=%d initrange=%f epochs=%f "
                  "avspe=%f bestdev=%f\n"
                  % (args.lamb, args.uembed, args.iembed, args.cembed, args.learnrate, args.mb,
